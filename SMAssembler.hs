...
memSize = 512
code = [fromEnum Dsp, 2, fromEnum Adr, -1, fromEnum Lit, 8, fromEnum Sto, fromEnum Stk, fromEnum Prs, 510, fromEnum Adr, -2, fromEnum Val, fromEnum Prn, fromEnum Hlt]
variables = [3,0]
